#ifndef GLBLENDWORK_H
#define GLBLENDWORK_H

#include "GLWork.h"

class GLBlendWork : public GLWork
{
public:
	GLBlendWork(const GLchar* vertexPath, const GLchar* fragmentPath, glm::vec3 cameraPos);
	~GLBlendWork();
...
GLBlendWork::GLBlendWork(const GLchar* vertexPath, const GLchar* fragmentPath, glm::vec3 cameraPos) :GLWork(vertexPath, fragmentPath, cameraPos)
{
}

GLBlendWork::~GLBlendWork()
{
}

void GLBlendWork::onDraw(int workIndex)
{
	if (workIndex == firstDraw)
	{
		...
		GLuint grass = loadTextureForRGBA("texImg\\grass.png");
